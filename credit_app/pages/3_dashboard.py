...
=======
st.title("Dashboard — Statistiques globales")
st.caption("Vue synthétique des volumes, des scores et des risques observés.")
...
df_dash = pd.DataFrame({
    ...
    "niveau_risque": np.random.choice(["Faible", "Modéré", "Élevé", "Très élevé"], n, p=[0.4, 0.3, 0.2, 0.1]),
})
...
tab1, tab2 = st.tabs(["Vue globale", "Analyse détaillée"])
